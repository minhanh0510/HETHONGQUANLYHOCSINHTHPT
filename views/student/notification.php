...
switch ($vaiTro) {
  case 'HocSinh': $displayName = 'Học sinh: '.$user['ho_ten']; $avatarText='HS'; break;
  case 'PhuHuynh': $displayName = 'Phụ huynh: '.$user['ho_ten']; $avatarText='PH'; break;
    default: $displayName = $user['ho_ten'] ?? 'Người dùng'; $avatarText='ND'; break;
}

// Giả sử $notifications là mảng dữ liệu thông báo từ DB
// $notifications = [...];
?>

<?php include __DIR__ . '/../layout/header.php'; ?>
<?php include __DIR__ . '/../layout/sidebar_student.php'; ?>
            ...
            <a href="index.php?controller=notification&action=detail&id=<?= $tb['maThongBao'] ?>" style="text-decoration:none;">
                <div class="notification-card <?= $isNew ? 'new' : '' ?>">
                    <h3>
                        ...
                        <?php if ($isNew): ?>
                            <span class="badge-new">MỚI</span> <!-- Hiển thị biểu tượng "MỚI" -->
                        <?php endif; ?>
                    </h3>
